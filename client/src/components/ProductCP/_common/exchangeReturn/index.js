  ...
  return (
    <MainStyle media={media}>
      ...
      <div>
        <p>교환/반품 불가한 경우</p>
        <p>
          1. <span>교환/반품 요청이 기간이 지난 경우</span>
        </p>
        <p>
          2.{' '}
          <span>
            소비자의 책임 있는 사유로 상품 등이 분실/파손/훼손된 경우 (단, 확인을 위한 포장 훼손
            제외)
          </span>
        </p>
        <p>
          3.
          <span>
            소비자의 사용/소비에 의해 상품 등의 가치가 현저히 감소한 경우 (예 : 식품, 화장품, 향수,
            음반)
          </span>
        </p>
        <p>
          4.
          <span>제품을 설치 또는 장착하였거나 개통한 경우 (예 : 전자제품, 컴퓨터, 휴대폰 등)</span>
        </p>
        <p>
          5.
          <span>
        ...
        <p>
          7.
          <span>주문제작 상품 중 상품제작에 들어간 경우 (주문접수 후 개별생산, 맞춤 제작 등)</span>
        </p>
      </div>
      <div>
        <p>판매자 정보</p>
        <p>
          상호명 : <span>(주)ESCKEY</span>
        </p>
        <p>
          대표자 : <span>이영규</span>
        </p>
        <p>
          연락처 : <span>010-1234-5678</span>
        </p>
        <p>
          통신판매업자번호 : <span>1234-1234-1234</span>
        </p>
        <p>
          사업자등록번호 : <span>123-45-67890</span>
        </p>
        <p>
          사업장소재지 : <span>-</span>
        </p>
        <p>
          E-mail : <span>iyeonggyu1234@gmail.com</span>
        </p>
      </div>
    </MainStyle>
  );
