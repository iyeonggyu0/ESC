...
import { Header, HeaderSection, Logo, Ul, SectionUl, HeaderMenu, MenuDiv, MenuUl, MobileHeader, MobileMenu, MobileMenuDiv } from "./style";
        ...
        <div>
          ...
          {menu === "block" && (
            <MobileMenu colorTheme={colorTheme}>
              ...
              <MobileMenuDiv>
                <span>견적내기</span>
                {mobileMenu1 === "none" && <FontAwesomeIcon icon={solid("caret-down")} className={"icon"} onClick={() => setMobileMenu1("block")} />}
                {mobileMenu1 === "block" && <FontAwesomeIcon icon={solid("caret-up")} className={"icon"} onClick={() => setMobileMenu1("none")} />}
                {mobileMenu1 === "block" && (
                  <div>
                    <p>취향찾기</p>
                  </div>
              ...
              <MobileMenuDiv>
                <span>전체상품</span>
                {mobileMenu2 === "none" && <FontAwesomeIcon icon={solid("caret-down")} className={"icon"} onClick={() => setMobileMenu2("block")} />}
                {mobileMenu2 === "block" && <FontAwesomeIcon icon={solid("caret-up")} className={"icon"} onClick={() => setMobileMenu2("none")} />}
                {mobileMenu2 === "block" && (
                  <div>
                    <p>CASE</p>
                    <p>PCB</p>
              ...
              <MobileMenuDiv>
                <span>고객센터</span>
                {mobileMenu3 === "none" && <FontAwesomeIcon icon={solid("caret-down")} className={"icon"} onClick={() => setMobileMenu3("block")} />}
                {mobileMenu3 === "block" && <FontAwesomeIcon icon={solid("caret-up")} className={"icon"} onClick={() => setMobileMenu3("none")} />}
                {mobileMenu3 === "block" && (
                  <div>
                    <p>커스텀 과정</p>
                    <p>FAQ</p>
