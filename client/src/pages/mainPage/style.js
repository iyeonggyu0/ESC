...
export const Advice = styled.div`
  ...
  & > div:first-child > p {
    font-family: Ubuntu;
    font-size: ${(props) => (props.media.isPc === true ? "45px" : (props) => (props.media.isTablet === true ? "35px" : (props) => (props.media.isMobile === true ? "25px" : "25px")))};
  }

  & > div:first-child > span {
    font-family: Gothic A1;
    line-height: 45px;
    font-size: ${(props) => (props.media.isPc === true ? ({ theme }) => theme.fontSize.xLarge : (props) => (props.media.isTablet === true ? ({ theme }) => theme.fontSize.large : (props) => (props.media.isMobile === true ? ({ theme }) => theme.fontSize.large : ({ theme }) => theme.fontSize.large)))};
  }
...
export const IconDiv = styled.div`
  ...
  border-top: 1px solid ${(props) => (props.colorTheme === "game" ? ({ theme }) => theme.palette.gameLightStroke : ({ theme }) => theme.palette.basicLightStroke)};
  border-bottom: 1px solid ${(props) => (props.colorTheme === "game" ? ({ theme }) => theme.palette.gameLightStroke : ({ theme }) => theme.palette.basicLightStroke)};
  ...
  .icon {
    font-size: ${(props) => (props.media.isPc === true ? "62px" : (props) => (props.media.isTablet === true ? ({ theme }) => theme.fontSize.xxxxLarge : ({ theme }) => theme.fontSize.xxxxLarge))};
    margin-bottom: 20px;
  }
`;
...
export const MainPageDiv = styled.div`
  ...
  color: ${(props) => (props.colorTheme === "game" ? ({ theme }) => theme.palette.white : ({ theme }) => theme.palette.basicFont)};
  z-index: 1;
